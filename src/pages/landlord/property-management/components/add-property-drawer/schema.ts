...
export const addPropertyDrawerFormSchema = z.object({
  ...
  depth: z.number().max(100, { message: "O imóvel deve ter no máximo 100 metros de fundo." }),
  width: z.number().max(50, { message: "O imóvel deve ter no máximo 50 metros de fundo." }),
  // amenities: z.array(),
});
